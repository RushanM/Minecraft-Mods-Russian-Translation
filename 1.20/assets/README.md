...
| Р.  | Название | Кодовое | Версия | Перевод | 🗿 Имелся | ✨ Качество | 📰 Главная | № | ⚙️ RPO | 📋 MM |
| --- | -------- | ------- | ------ | ------- | - | - | - | - | - | - |
...
* **1.20** — 1.20.x
* **Бел.** — белорусский
* **Имелся** — мод изначально имел перевод на русский?
...
* **Главная** — дата проверки наличия мода на общей таблице
